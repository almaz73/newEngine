<template>
    <AppModal v-if="isOpen"
      ...
      <el-scrollbar>
        ...
        <div class="modal-fields">
            ...
            <el-form-item prop="typeTitle" :rules="{required: true, message: 'Название', trigger: ['change']}">
              ...
              <el-select
                  ...
                  filterable
                  clearable>
                <el-option v-for="item in colorTypeList" :key="item.code" :label="item.name"
                           :value="item.code"/>
             </el-select>
            </el-form-item>
  ...
  function open(row, cbModal,copy) {
    cb = cbModal;
    isOpen.value = true;
    if (!row) model.value = {orgElements:[], departments:[], rate: null };
    else{
