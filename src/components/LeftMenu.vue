    ...
    >
      <RouterLink to="/desktop">
        <el-menu-item index="1">
          <el-icon>
            <img alt="Рабочий стол" src="@/assets/icons/ic-desktop-windows-black-18-px.png" />
          </el-icon>
      ...
      <RouterLink to="/appeal">
        <el-menu-item index="2">
          <el-icon>
            <img alt="Обращения" src="@/assets/icons/ic-people-black-18-px.png" />
          </el-icon>
      ...
      <RouterLink to="/deal">
        <el-menu-item index="3">
          <el-icon>
            <img alt="Оценки" src="@/assets/icons/ic-directions-car-black-18-px.png" />
          </el-icon>
      ...
      <RouterLink to="/ideas">
        <el-menu-item index="4">
          <el-icon>
            <img alt="Склад" src="@/assets/icons/ic-home-black-18-px.png" />
          </el-icon>
      ...
      <el-menu-item index="5" disabled>
        <el-icon>
          <img alt="Звонки" src="@/assets/icons/ic-call-black-20-px.png" />
        </el-icon>
      ...
      <el-menu-item index="7">
        <el-icon>
          <img alt="Управление" src="@/assets/icons/ic-import-export-black-18-px.png" />
        </el-icon>
      ...
      <el-menu-item index="8">
        <el-icon>
          <img alt="Cобытия" src="@/assets/icons/ic-done-all-black-18-px.png" />
        </el-icon>
      ...
      <el-menu-item index="9">
        <el-icon>
          <img alt="Аналитика" src="@/assets/icons/ic-trending-up-black-18-px.png" />
        </el-icon>
      ...
      <RouterLink to="/">
        <el-menu-item index="10">
          <el-icon>
            <img alt="Плановые показатели" src="@/assets/icons/icon-plan-indicator.png" />
          </el-icon>
      ...
      <el-menu-item index="11">
        <el-icon>
          <img alt="Заявки на кредит" src="@/assets/icons/ic-account-balance-black-18-px.png" />
        </el-icon>
      ...
      <el-menu-item index="12">
        <el-icon>
          <img alt="Реализация" src="@/assets/icons/ic-shopping-cart-black-18-px.png" />
        </el-icon>
      ...
      <el-menu-item index="13">
        <el-icon>
          <img alt="Страховые полисы" src="@/assets/icons/icon-insurance-policies.png" />
        </el-icon>
      ...
      <el-menu-item index="14">
        <el-icon>
          <img alt="Доп.оборудование" src="@/assets/icons/icon-equip.png" />
        </el-icon>
      ...
      <el-menu-item index="15">
        <el-icon>
          <img alt="отчеты" src="@/assets/icons/icon-reports.png" />
        </el-icon>
      ...
      <el-menu-item index="16">
        <el-icon>
          <img alt="Новости" src="@/assets/icons/ic-chat-black-18-px.png" />
        </el-icon>
      ...
      <el-menu-item index="17">
        <el-icon>
          <img alt="Система" src="@/assets/icons/ic-system-inactive.png" />
        </el-icon>
      ...
      <RouterLink to="/desktop">
        <el-menu-item index="18">
          <el-icon>
            <img alt="Помощь" src="@/assets/icons/ic-help-red-18-px.png" />
          </el-icon>
      ...
      <el-menu-item index="19">
        <el-icon>
          <img alt="Анкеты" src="@/assets/icons/icon-questionnaires.png" height="34" />
        </el-icon>
