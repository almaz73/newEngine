<template>
  ...
  >
    <div :style="{width:isCollapse?'72px':'216px'}" style="background: red; height: 72px; transition: width">
      <img src="@/assets/img/small-logo.png" style="width: 100%; height: 72px" v-if="isCollapse"/>
